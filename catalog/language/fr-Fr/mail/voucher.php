...
$_['text_greeting'] ='Félicitations, vous avez reçu un certificat-cadeau d`une valeur de %s';
$_['text_from']     ='Ce certificat-cadeau vous a été envoyé par %s';
$_['text_message']  ='Avec un message disant';
$_['text_redeem']   ='Pour échanger ce certificat-cadeau, écrivez le code de rachat qui est <b> %s </b> Puis cliquez sur le lien ci-dessous et achetez le produit que vous souhaitez utiliser ce certificat-cadeau sur. Vous pouvez entrer le code du certificat-cadeau sur la page du panier avant de cliquer sur le bon de paiement.';
